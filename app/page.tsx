                  ...
                  <div className="bg-slate-900/60 border border-slate-800/80 rounded-xl p-4 col-span-2 space-y-3.5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-950/40 p-2.5 rounded-lg border border-slate-800/40 flex justify-between items-center">
                        ...
                        <div className={`flex items-center gap-0.5 text-[10px] font-mono ${stats.total_cap_change >= 0 ? "text-emerald-500" : "text-rose-500"}`}>
                          {stats.total_cap_change >= 0 ? <TrendingUp className="w-3 h-3" /> : <TrendingDown className="w-3 h-3" />}
                      ...
                      <div className="bg-slate-950/40 p-2.5 rounded-lg border border-slate-800/40 flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-0.5 text-[10px] font-mono text-rose-500">
              ...
              <section className="bg-slate-900/40 border border-slate-800/60 p-4 md:p-6 rounded-2xl shadow-inner space-y-4">
                ...
                <div className={`grid gap-4 ${viewMode === "mobile" ? "grid-cols-1" : "grid-cols-3"}`}>
                  <div className="bg-slate-900/60 border border-slate-800/80 rounded-xl p-4 space-y-2.5">
                    <span className="text-xs font-bold text-slate-400 block pb-1 border-b border-slate-800/60">🇺🇸 미국 국채 금리</span>
            ...
            <>
              ...
              <section className="bg-slate-900/40 border border-slate-800/60 p-4 md:p-6 rounded-2xl shadow-inner space-y-4">
                <div className="border-b border-slate-800 pb-3">
                  <h2 className="text-base md:text-lg font-bold text-slate-200 flex items-center gap-2">
                    <LineChart className="w-5 h-5 text-emerald-400" /> 실시간 온체인 데이터
                  </h2>
                ...
                {/* 💡 [모바일 최적화 완결] 기존에 디바이스 모드를 무시하고 md 단락만 타던 구조를 grid-cols-1로 철저하게 가둬 고정 해제했습니다 */}
                <div className={`grid gap-4 ${viewMode === "mobile" ? "grid-cols-1" : "grid-cols-1 md:grid-cols-3"}`}>
                  ...
                  <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl shadow-lg flex flex-col justify-between space-y-3">
                    <div className="flex justify-between items-center w-full">
                      <span className="text-sm font-bold text-emerald-400 font-mono">MVRV Ratio</span>
                    ...
                    <div className="pt-2 border-t border-slate-800/80 text-xs text-slate-400 leading-relaxed">
                      💡 <span className="text-slate-300 font-semibold">역사적 바닥/고점:</span> 1 이하는 <span className="text-blue-400 font-bold">찐바닥</span> / 3.7 이상은 <span className="text-rose-400 font-bold">꼭대기</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl shadow-lg flex flex-col justify-between space-y-3">
                    <div className="flex justify-between items-center w-full">
                      <span className="text-sm font-bold text-blue-400 font-mono">NVT Ratio (PER 개념)</span>
                    ...
                    <div className="pt-2 border-t border-slate-800/80 text-xs text-slate-400 leading-relaxed">
                      📈 <span className="text-slate-300 font-semibold">시장 거품 평가:</span> 거래량 대비 <span className="text-emerald-400 font-medium">적정 거품 없는 구간 진단</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl shadow-lg flex flex-col justify-between space-y-3">
                    <div className="flex justify-between items-center w-full">
                      <span className="text-sm font-bold text-orange-400">거래소 고래 유입량</span>
                    ...
                    <div className="pt-2 border-t border-slate-800/80 text-xs text-slate-400 leading-relaxed">
                      ⚠️ <span className="text-slate-300 font-semibold">매도 압력 시그널:</span> 수치 급증 시 <span className="text-rose-400 font-bold">강한 매도 압력 유의</span>
                    </div>
                  </div>
              ...
              <section className="bg-slate-900/40 border border-slate-800/60 p-4 md:p-6 rounded-2xl shadow-inner space-y-4">
                <h2 className="text-base md:text-lg font-bold text-yellow-400 flex items-center gap-2">
                  <Zap className="w-5 h-5" /> 실시간 선물 펀딩비
                </h2>
                <div className={`grid gap-3 ${viewMode === "mobile" ? "grid-cols-2" : "grid-cols-2 lg:grid-cols-4"}`}>
                  <div className="bg-slate-900 border border-slate-800 p-3.5 rounded-xl flex flex-col justify-between h-24">
                    ...
                    <span className="text-[9px] text-emerald-500 bg-emerald-500/10 px-1.5 py-0.5 rounded w-max">정상</span>
                  </div>
                  <div className="bg-slate-900 border border-slate-800 p-3.5 rounded-xl flex flex-col justify-between h-24">
                    ...
                    <span className="text-[9px] text-yellow-500 bg-yellow-500/10 px-1.5 py-0.5 rounded w-max">주의</span>
                  </div>
                  <div className="bg-slate-900 border border-slate-800 p-3.5 rounded-xl flex flex-col justify-between h-24">
                    ...
                    <span className="text-[9px] text-rose-500 bg-rose-500/10 px-1.5 py-0.5 rounded w-max">역펀딩</span>
                  </div>
                  <div className="bg-slate-900 border border-slate-800 p-3.5 rounded-xl flex flex-col justify-between h-24">
